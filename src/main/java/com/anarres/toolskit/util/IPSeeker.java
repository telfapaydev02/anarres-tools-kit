...
import com.anarres.toolskit.support.CharsetKit;
...
//    private static final String IP_FILE = IPSeeker.class.getResource("/QQWry.Dat").getPath();
    // 一些固定常量，比如记录长度等等   
...
//                System.out.println("IP地址信息文件格式有错误，IP显示功能将无法使用");
    ...
    private String readString(long offset) {
        try {   
            ...
            if(i != 0)   
                return CharsetKit.string(buf, 0, i, "GBK");
        } catch (IOException e) {
            System.out.println(e.getMessage());
        }   
        return "";   
    ...
    public String getAddress(String ip){
       ...
       // System.out.println("地点："+country);
        String area = getArea(ip).equals(" CZ88.NET")?"":getArea(ip);
       // System.out.println("网络类型："+area);
        return country.trim();
    }   
    
//    public static void main(String args[]){
////    	System.out.println(getInstance().getAddress("119.75.217.56"));
////    	System.out.println(getInstance().getAddress("221.6.231.216"));
////    	System.out.println(getInstance().getAddress("222.184.14.7"));//222.45.196.89
//        System.out.println(IPSeeker.class.getResource("QQWry.Dat").toString().substring(5));
//    	System.out.println(getInstance().getAddress("124.228.191.61"));
//    }
}  