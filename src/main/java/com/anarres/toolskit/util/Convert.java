...
import com.anarres.toolskit.support.*;
...
public class Convert {
	...
	public static Object parse(Class<?> clazz, Object value) {
		try {
			if (clazz.isAssignableFrom(String.class)) {
				...
				if (CharsetKit.isBlank(String.valueOf(value)))
					return " ";
				else
			...
			// 未找到可转换的类型，返回原值
			return (CharsetKit.isBlank(valueStr)) ? null : value;
		}
	}
	...
	public static Character toChar(Object value, Character defaultValue) {
		...
		return CharsetKit.isEmpty(valueStr) ? defaultValue : valueStr.charAt(0);
	}
	...
	public static Byte toByte(Object value, Byte defaultValue) {
		...
		final String valueStr = toStr(value, null);
		if (CharsetKit.isBlank(valueStr)) {
			return defaultValue;
		}
		try {
			return Byte.parseByte(valueStr);
	...
	public static String convertCharset(String str, String sourceCharset, String destCharset) {
		if (CharsetKit.hasBlank(str, sourceCharset, destCharset)) {
			return str;
		}
