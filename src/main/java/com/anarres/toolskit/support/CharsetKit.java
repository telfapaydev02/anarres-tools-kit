...
public class CharsetKit {
	...
	public static Object parseOf(String str, Class<?> clazz) {
	...
	public static ByteBuffer byteBuffer(String str, String charset) {
		return ByteBuffer.wrap(CharsetKit.bytes(str, charset));
	}
	...
	public static String convert(String source, String srcCharset, String newCharset) {
		if(CharsetKit.isBlank(srcCharset)) {
			srcCharset = ISO_8859_1;
		}

		if(CharsetKit.isBlank(newCharset)) {
			srcCharset = UTF_8;
		}

		if (CharsetKit.isBlank(source) || srcCharset.equals(newCharset)) {
			return source;
		}
		try {
	...
	public static ByteBuffer toByteBuffer(String str, String charset) {
		return ByteBuffer.wrap(CharsetKit.encode(str, charset));
	}
